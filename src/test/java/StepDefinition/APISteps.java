...
public class APISteps {
    ...
    public void userSendsAGETRequestTo(String endurl) {
        ...
        bassUtiles.getRequest(endurl);

        String requestBody = bassUtiles.getResponseBody();
    ...
    public void the_response_should_contain_to_get_a_token() {
        ...
        String token = bassUtiles.jsonpathfrom(responseBody, "token");
